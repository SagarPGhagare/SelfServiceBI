...
[data-draggable="target"]
{
  ...
  $(document).ready(function(){
	...
	/*   
		...
		var table_name=${listValue.tableName};
		
		console.log("table:"+table_name);
		
		if(table_name.include("Dim"))
			{
			...
			<div class="navbar-default sidebar" role="navigation">
				<div  id="left-collapse" class="sidebar-nav navbar-collapse" >
					...
					<ul id="tree3" >
						...
						<%-- <li> <a id="main"  href="sql"><i
								class="glyphicon glyphicon-home"></i>&nbsp;&nbsp;<span
								style="font-size: 14px;"> File System</span></a>
									<ul>
									
										<c:forEach var="listValue" items="${lists}" varStatus="status">
										<c:if test="${listValue.tableName=='BankAccTrancView'}">
										<li>
											<a id="tableid_${listValue.tableName}" draggable="true" href="#"> ${listValue.tableName}</a>
											<ul id="ulTable">
												<c:forEach var="listValue1" items="${listValue.colDetail}"
													varStatus="status1">
													<li draggable="true">
														<a id="${listValue.tableName}_column${status1.count}" href="#"
														 data-toggle="tooltip" title="${listValue1.colDataType}" data-placement="right"  class="red-tooltip">${listValue1.colName}</a>
													</li>
												</c:forEach>
											</ul>
										</li>
							...
							<li > <a id="main"  href="sql"><i
								class="glyphicon glyphicon-home"></i>&nbsp;&nbsp;<span
								style="font-size: 14px;"> Mysql</span></a>
